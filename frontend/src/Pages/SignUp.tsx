...
const SignUp = () => {
  ...
  return (
    <div
      ...
      style={{
        background: "linear-gradient(135deg, #a8edea 0%, #fed6e3 25%, #ffecd2 50%, #fcb69f 75%, #667eea 100%)",
      }}
    >
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center mb-4">
              <img src="/logo.png" alt="SportSync Logo" className="h-16 w-auto object-contain" />
            </div>
            <h2 className="text-2xl font-semibold text-black mb-2">Sign up to SportSync</h2>
            <p className="text-gray-600 text-sm">Quick & Simple way to Automate your bookings</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                ...
                <button className="text-blue-600 hover:text-blue-800 font-semibold">Log In</button>
              </p>
            </div>
          </form>
        </div>
